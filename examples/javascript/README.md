...
Submits to `POST /v1/tasks` (`task_type=amazon`), polls `POST /v1/gettasks`, returns the result URL. For a server-side Node.js version see [`../nodejs`](../nodejs). Full docs: https://docs.checknumber.ai/amazon-bulk-number-checker
