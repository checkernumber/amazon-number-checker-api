# Amazon Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Amazon Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/amazon
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=amazon"
...
| --- | --- | --- | --- | --- | --- |
| `amazon` | Number Checker | phone | 100–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/amazon-bulk-number-checker) |
| `amazon_email` | Email Checker | email | 100–10000000 rows | `email, activated` | [docs](https://docs.checknumber.ai/amazon-email-checker) |
...
- `amazon`: https://docs.checknumber.ai/amazon-bulk-number-checker
- `amazon_email`: https://docs.checknumber.ai/amazon-email-checker
