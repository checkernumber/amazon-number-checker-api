// Amazon Number Checker API — browser/JavaScript example.
// Workflow: submit a file of E.164 numbers -> poll status -> download results.
// Docs: https://docs.checknumber.ai/amazon-bulk-number-checker
//
...
const TASK_TYPE = "amazon"; // amazon | amazon_email
...
async function checkAmazon(file) {
...
//   const url = await checkAmazon(e.target.files[0]);
